...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, LocationListener {
    ...
    // Methods from the implementation of the "LocationListener" interface. Used to get the mobiles location from the GPS
    // Method that is called when the location of the mobile is changed
    @Override
    ...
    // Method that is called when the status of the mobile is changed IE when the mobile looses connection
    @Override
    public void onStatusChanged(String provider, int status, Bundle extras) {
        Toast.makeText(this, "Status Changed: " + status, Toast.LENGTH_LONG).show();
    }

    // Method that is called when the GPS location is enabled
    @Override
    public void onProviderEnabled(String provider) {
        Toast.makeText(this, "Provider " + provider + " enabled", Toast.LENGTH_LONG).show();
    }

    // Method that is called when the GPS location is disabled
    @Override
